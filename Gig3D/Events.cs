...
namespace Gig3D
{
    public class EventMsg
    {
        ...
        public int lParam;
        public int wParam;
        public EventMsg(int message, int lParam, int wParam)
        {
    ...
    public class KeyEvents : EventArgs
    {
        ...
        public KeyCode Key;
        public KeyEvents(KeyCode Key)
        {
            this.Key = Key;
        }
    }
    public class MouseKeyEvents : EventArgs
    {
        ...
        public int? whell_delta;
        public bool shift, ctrl;
        public int x, y;
        public MouseKeyEvents(MouseButton button, bool shift, bool ctrl, int x, int y)
        {
            this.button = button;
            this.ctrl = ctrl;
            this.shift = shift;
        ...
        public MouseKeyEvents(int whell_delta, bool shift, bool ctrl, int x, int y)
        {
            this.whell_delta = whell_delta;
            this.ctrl = ctrl;
            this.shift = shift;
            this.x = x;
            this.y = y;
